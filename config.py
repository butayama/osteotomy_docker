...
class Config:
    SECRET_KEY = os.environ.get('SECRET_KEY') or 'ESTBytlXqEkSd6At4nEVJTDdby0rYphmLKX3WKAgUP2dUkoD'
    ...
    # SERVER_NAME = 'osteotomytool.de' for test test_home_page does not work
